...
const Companies = (props: Props) => {
  return (
    <>
      <section id="companies" className={`mt-20 mb-40 ${style.section}`}>
      ...
      <p className="text-center mx-auto mt-4 min-w-[300px] max-w-[60%] leading-8 tracking-wide text-text-dark">
       <span className="text-main-green p-0.5 ">MOVIE CITY</span> website contains thousands of movies and series that produced by most famous companies all around the world such as : 
      </p>
        <Marquee pauseOnHover speed={40} pauseOnClick autoFill className="mt-10">
