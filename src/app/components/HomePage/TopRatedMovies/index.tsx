  ...
  return (
    <>
      <section className="mb-12">
        ...
        <div
          className={`flex flex-col mx-auto justify-center sm:flex-row-reverse sm:justify-around gap-4 py-4 xxs:px-2 sm:px-4 max-w-[450px] sm:max-w-full ${style.container}`}
        >
